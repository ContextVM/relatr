...
### Registering as a TA Subscriber

Clients can register via the MCP `register_ta_provider` tool:

```json
{
  "tool": "register_ta_provider",
  "params": {}
}
```

### Publishing TA Events

TA events are published automatically after registration.

### TA Event Format

Published events follow NIP-85:

```json
{
  "kind": 30382,
  "pubkey": "relatr_server_pubkey",
